...
def registerPage(request):
    ...
    return render(request, 'rooms/login_register.html', {'form': form})
...
def updateUser(request):
    ...
    return render(request, 'rooms/update-user.html', {'form': form})
...
def activityPage(request):
    ...
    return render(request, 'rooms/activity.html', {'room_messages': room_messages})